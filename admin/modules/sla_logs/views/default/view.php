...
class sla_logs_view extends slaView implements iView{
	...
	public function show_items($message="") {
		...
		echo "<table width='100%' cellspacing='0' cellpadding='0' border='0'>
				<tr><td>
					<table width='100%' cellspacing='0' cellpadding='0' border='0'><tr>
						...
						".$this->slash->trad_word("SLA_LOGS_TITLE");
		...
		//control buttons
		sl_interface::create_control_buttons($this->controller->module_name,array('delete'));		
					
		echo "</td></tr></table>";
		echo "<table width='100%' cellspacing='0' cellpadding='0' border='0'><tr><td class='sl_mod_list'>";
				
		$this->controller->logs->load_items(); // Load logs list
	...
	*/
	public function show_form ($id=0, $values=null, $errors=null) {
		...
		echo "<div class='sl_adm_form_top'>";
			sl_interface::create_title($mn,$this->slash->trad_word("SLA_LOGS_TITLE"),$utitle);
		...
		echo "	<form name='".$this->controller->module_name."_del_form' method=post action='index.php?mod=".$this->controller->module_name."'>
				...
				<td>
					...
					<tr>
						...
						<img src='modules/".$this->controller->module_name."/views/default/images/".$this->controller->module_name.".png' align='absmiddle' /> 
						".$this->slash->trad_word("SLA_LOGS_TITLE")." >>> <span class='sl_mod_undertitle'>".$this->slash->trad_word("DELETE")."</span></td>
					...
					<tr>
						<td align='left'>		
							...
							<tr>
								<td align='left' class='sl_mod_field_title' width='50%'>".$this->slash->trad_word("SLA_LOGS_DELETE_CONFIRM")." 
								</td>
							</tr>";
