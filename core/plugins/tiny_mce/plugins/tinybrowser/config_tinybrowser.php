...
$tinybrowser['path']['image'] = '../../../../../medias/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '../../../../../medias/videos/'; // Media files location
$tinybrowser['path']['file']  = '../../../../../medias/files/'; // Other files location
...
$tinybrowser['link']['image'] = "http://".$_SERVER['HTTP_HOST']."/medias/images/"; //$tinybrowser['path']['image']; // Image links
