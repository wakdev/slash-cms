...
--
-- Client: localhost
-- GÈnÈrÈ le: Mar 02 Avril 2013 ‡ 18:22
...
INSERT INTO `sl_articles` (`id`, `id_user`, `title`, `content`, `date`, `enabled`) VALUES
...
--
-- Structure de la table `sl_joins`
--

CREATE TABLE IF NOT EXISTS `sl_joins` (
...
--
-- Contenu de la table `sl_joins`
--

INSERT INTO `sl_joins` (`id_mod1`, `id_mod2`, `id_mod3`, `id1`, `id2`, `id3`, `item_data`, `item_order`, `item_enabled`) VALUES
(13, 7, 0, 3, 2, 0, '', 0, 0),
(13, 7, 0, 3, 1, 0, '', 0, 0),
(13, 7, 0, 4, 2, 0, '', 0, 0);
...
(2, 1, 2, 'url_self', 0, 0, 'Pr√©sentation', 'index.php?mod=sl_pages&id=1', 1, 1),
(3, 1, 2, 'url_self', 0, 1, 'Actualit√©s', 'index.php?mod=sl_pages&id=2', 0, 1),
(5, 1, 2, 'url_self', 0, 2, 'T√©l√©chargement', 'index.php?mod=sl_pages&id=3', 0, 1),
